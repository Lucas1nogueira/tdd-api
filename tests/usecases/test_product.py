...
async def test_usecases_get_should_not_found():
    with pytest.raises(NotFoundException) as e:
        await product_usecase.get(id=UUID("8621cd38-9a17-440b-ac0c-3ed448b74c28"))

    assert (
        e.value.message
        == "Product not found with filter: 8621cd38-9a17-440b-ac0c-3ed448b74c28"
    )
...
async def test_usecases_delete_should_not_found():
    with pytest.raises(NotFoundException) as e:
        await product_usecase.delete(id=UUID("8621cd38-9a17-440b-ac0c-3ed448b74c28"))
